...
const EMAIL_FIELD_ID = "download-dialog-email";
  ...
  return (
    <>
      <Dialog
        ...
        className="max-w-[440px] rounded-md border-ink bg-surface-card p-7 shadow-stamp"
        onOpenAutoFocus={(event) => {
          // Radix focus par défaut le premier élément focusable du contenu (le bouton "Fermer") ;
          // on redirige vers le champ e-mail, comme avant le passage à Radix.
      ...
      >
        ...
        {sent ? (
          <div className="py-4 text-center">
            ...
            <DialogTitle asChild>
              <h2 className="mb-3 text-xl font-semibold text-ink">
                Le lien de téléchargement vient de partir vers votre adresse. Il reste valable sept
                jours.
              </h2>
            </DialogTitle>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <DialogTitle asChild>
              <h2 className="text-xl font-semibold text-ink">Télécharger « {ressource.title} »</h2>
            </DialogTitle>
            <p className="text-sm leading-relaxed text-text-muted">
              Le téléchargement est gratuit. Nous demandons une adresse électronique pour savoir qui
              utilise nos guides et vous prévenir des versions mises à jour.
            </p>
