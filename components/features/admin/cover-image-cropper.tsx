...
export function CoverImageCropper({
  ...
  return (
    <div className="fixed inset-0 z-100 flex flex-col gap-4 bg-ink/80 p-6">
      <div className="relative mx-auto flex w-full max-w-160 flex-1 flex-col gap-4 rounded-lg bg-surface-card p-5">
        <span className="text-[0.6875rem] font-semibold tracking-[0.13em] text-muted-foreground uppercase">
          Recadrer l’image
        </span>
        <div className="relative flex-1 overflow-hidden rounded-md bg-ink">
          <Cropper
            image={imageSrc}
            crop={crop}
            zoom={zoom}
